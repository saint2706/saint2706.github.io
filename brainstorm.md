...
- **Mission:** To demonstrate not just _competence_, but _mastery_ of the modern web stack — where **less JavaScript = more capability**.
...
- **Benefit:** No waterfall requests. Data is ready _before_ the component renders. Better error boundaries with `<Suspense>`.
- **2026 Enhancement:** Pair with **Speculation Rules** — data is not only pre-fetched, it's pre-_rendered_ in a hidden tab.

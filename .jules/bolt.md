...
- **[PERF] SyntaxHighlighter Memoization**: Wrapped component in `React.memo` in `src/components/shared/SyntaxHighlighter.jsx` to prevent unnecessary re-renders when parent states change, especially during active typing or chatting.

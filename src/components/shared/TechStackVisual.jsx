    ...
    return (
        ...
        >
            ...
            >
                ...
                <span
                    className="text-sm font-heading font-bold whitespace-nowrap text-black"
                >
                    {skill.name}
                </span>
 ...
 */
const CategoryBranch = ({ category, skills, color, hoveredSkill, setHoveredSkill, shouldReduceMotion, delay }) => {
    return (
        <motion.div

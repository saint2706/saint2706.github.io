  ...
  sudo hire rishabh → ???`
                ...
                case 'goto': {
                    ...
                    if (route) {
                        ...
                        pushOutput(`Error: page '${page}' not found. Type 'ls' to see available pages.`, 'error');
                    }
                    break;
                }
        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    >
                        <div
                            className="flex flex-col bg-gray-950 border-nb border-[color:var(--color-border)] overflow-hidden rounded-nb"
                            style={{ boxShadow: '8px 8px 0 var(--color-border)' }}
                        >
                            {/* Title Bar */}
                            <div className="flex items-center justify-between px-4 py-2.5 bg-gray-900 border-b-2 border-gray-700">
                            ...
                            <div
                                ref={outputRef}
                                className="flex-1 overflow-y-auto p-4 min-h-[300px] max-h-[60vh] font-mono text-sm leading-relaxed"

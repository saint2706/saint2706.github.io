  ...
  return (
    <div className="fixed bottom-24 right-6 z-40">
      <div className="relative group">
        ...
        {/* Tooltip */}
        {!roast && (
          <span className="absolute right-full mr-2 top-1/2 -translate-y-1/2 bg-slate-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
            Roast My Resume
          </span>
        )}

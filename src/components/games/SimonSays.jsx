            ...
            <div className="relative">
                ...
                >
                    ...
                    <div className="text-center mb-4">
                        <span
                            className={`inline-block px-3 py-1 text-sm font-heading font-bold border-[2px] border-[color:var(--color-border)] ${gameState === 'watching'
                    ...
                    <div className="grid grid-cols-2 gap-4" role="group" aria-label="Simon Says buttons">
                        {COLORS.map(color => (
                            <motion.button
                                ...
                                whileTap={
                                    shouldReduceMotion || gameState !== 'input' ? undefined : { scale: 0.9 }
                                }

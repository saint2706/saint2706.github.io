      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="group relative flex items-center gap-2 px-3 py-2 bg-card border-2 border-[color:var(--color-border)] text-primary transition-all duration-200 cursor-pointer hover:-translate-x-0.5 hover:-translate-y-0.5 disabled:opacity-60 disabled:cursor-not-allowed"

...
import { snippets, getSnippetsByLanguage } from '../../data/snippets';
...
const Playground = () => {
    ...
    const description = 'Explore powerful Python one-liners and creative CSS snippets. Copy, learn, and experiment with advanced code techniques.';
            ...
            <div className="max-w-6xl mx-auto py-12 px-4">
                ...
                >
                    ...
                    <p className="text-secondary max-w-2xl mx-auto mt-6 font-sans">
                        Powerful Python one-liners and creative CSS snippets. Copy, learn, and make them your own.
                    </p>
                </motion.div>
                ...
                >
                  ...
                  ${activeFilter === filter.id
                                ...
                                style={{ boxShadow: activeFilter === filter.id ? 'var(--nb-shadow-hover)' : 'var(--nb-shadow)' }}
                            >
        ...
        >
            ...
            <div className="p-5 flex-grow flex flex-col">
                ...
                <div className="flex justify-between items-start mb-3">
                    ...
                    <span className={`text-xs font-bold px-2 py-1 rounded-nb border-2 border-[color:var(--color-border)] ${snippet.language === 'python' ? 'bg-accent text-white' : 'bg-fun-pink text-white'
                        }`}>
                ...
                <div className="relative mb-4 flex-grow">
                    ...
                    <button
                        ...
                        className={`absolute top-2 right-2 p-2 rounded-md border-2 border-[color:var(--color-border)] transition-all ${isCopied
                            ? 'bg-green-500 text-white'
                            : 'bg-card text-primary hover:bg-fun-yellow'
                            }`}

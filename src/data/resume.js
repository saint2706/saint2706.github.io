  ...
  projects: [
    {
      ...
      image: '/images/projects/coding-for-mba.webp',
      stars: 69,
      featured: true,
    },
    {
      ...
      description:
        'Full-stack facial recognition attendance platform with real-time face detection, automated check-ins, and comprehensive analytics dashboard.',
      ...
      image: '/images/projects/attendance-ai.webp',
      featured: true,
    },
    {
      title: 'Client Modding Guide',
      description:
        'Comprehensive guide for Discord client modding with step-by-step tutorials. Most starred personal project with active community engagement.',
      tags: ['Documentation', 'Discord', 'Modding', 'Community'],
      github: 'https://github.com/saint2706/Client-Modding-Guide',
      image: '/images/projects/modding-guide.webp',
      stars: 75,
      featured: true,
    },
    {
      ...
      description:
        'An interactive meditation journey application combining philosophy with technology for mindful experiences.',
      tags: ['Python', 'Meditation', 'Interactive', 'Wellness'],
      github: 'https://github.com/saint2706/scroll-of-dharma',
      image: '/images/projects/scroll-dharma.webp',
      featured: true,
    },
    {
      title: 'VITable',
      description:
        'Elegant timetable viewer for VIT students built with Nim programming language. Clean UI for schedule management.',
      tags: ['Nim', 'Utility', 'VIT', 'Scheduling'],
      github: 'https://github.com/saint2706/vitable',
      image: '/images/projects/vitable.webp',
      featured: false,
    },
    {
      title: 'Geralt Discord Bot',
      description:
        'Feature-rich Discord bot with custom commands, moderation tools, and entertainment features.',
      tags: ['Python', 'Discord.py', 'Bot', 'Automation'],
      github: 'https://github.com/saint2706/geralt',
      image: '/images/projects/geralt-bot.webp',
      featured: false,
    },
    {
      title: 'VIT Academics Enhancer',
      description:
        "Chrome extension that enhances VIT's Academics Portal with improved UI/UX and additional features.",
      tags: ['JavaScript', 'Chrome Extension', 'VIT', 'UI/UX'],
      github: 'https://github.com/saint2706/Enhancer-for-VIT-Vellore-Academics',
      image: '/images/projects/vit-enhancer.webp',
      featured: false,
    },
    {
      title: 'Python Course - GIM BDA',
      description:
        'Jupyter notebook-based Python course materials for Big Data Analytics students at GIM.',
      tags: ['Python', 'Jupyter', 'Education', 'Data Science'],
      github: 'https://github.com/saint2706/Python-Course-GIM-BDA',
      image: '/images/projects/python-gim.webp',
      featured: false,
    },
  ],
  certifications: [
    ...
    {
      name: 'Java Programming: Solving Problems with Software (with Honors)',
      issuer: 'Coursera',
      date: 'Nov 2021',
    },
    {
